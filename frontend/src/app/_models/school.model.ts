export class School {
  ...
  deserializeFromFile(input: any): this {
    ...
    this.computer_availability_bool = this.getBoolean(input.computer_availability);
    this.city = input.city;
    this.city_code = input.city_code || '';
    this.dq_score = parseFloat(input.dq_score);
    this.internet_availability_prediction_bool = this.getBoolean(
    ...
    if (input.internet_availability !== 'Yes' && input.internet_availability !== 'No') {
      ...
      this.internet_availability_bool = this.getBoolean(
