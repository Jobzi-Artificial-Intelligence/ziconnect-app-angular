...
describe('Model: School', () => {
  ...
  describe('#deserialize', () => {
    ...
    it('should works #1', () => {
      ...
      expect(school.internet_availability_bool).toEqual(schoolFromServer.internet_availability);
      expect(school.internet_availability_prediction_bool).toEqual(schoolFromServer.internet_availability_prediction);
      ...
      expect(school.internet_speed_mbps).toEqual(schoolFromServer.internet_speed_mbps);
      ...
      expect(school.student_count).toEqual(schoolFromServer.student_count);
